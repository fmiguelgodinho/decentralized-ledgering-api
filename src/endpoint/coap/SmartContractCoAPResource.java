...
public class SmartContractCoAPResource extends CoapResource {
	...
	public SmartContractCoAPResource(ContractInterpreter ci) {
		super();
		this.ci = ci;
	}
	...
	public void get(CoapExchange ex) throws CoapCodeException {
		...
		try {
			result = ci.verifyAndExecuteContract(
					EntityType.ENTITY_TYPE_IOT_DEVICE,
					Dispatcher.CHAINCODE_QUERY_OPERATION, 
					rp.channel, 
					rp.cid, 
					rp.oid,
					null, 			// TODO: ignore this when CoAP!
					rp.args
			);
